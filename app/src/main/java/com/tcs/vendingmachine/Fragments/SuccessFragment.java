...
public class SuccessFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(bundle!=null){
            double mTotalAmt = bundle.getDouble(Constants.TOTAL);
            double mInsertedAmt = bundle.getDouble(Constants.INSERTED);
            mChange = bundle.getDouble(Constants.CHANGE);
